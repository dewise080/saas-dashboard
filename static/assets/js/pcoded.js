...
for (var t = 0; t < tc.length; t++) {
  tc[t].setAttribute('src', '../assets/images/logo-dark.png');
}
...
function layout_change(layout) {
  ...
  if (layout == 'dark') {
    ...
    if (document.querySelector('[data-pc-layout="horizontal"] .pc-sidebar .m-header .logo-lg')) {
      document.querySelector('[data-pc-layout="horizontal"] .pc-sidebar .m-header .logo-lg').setAttribute('src', '../assets/images/logo-dark.png');
    }
    if (document.querySelector('.auth-wrapper a>img')) {
      document.querySelector('.auth-wrapper a>img').setAttribute('src', '../assets/images/logo-dark.png');
    }
